  ...
  <footer id="footer">
        ...
        <script src="{{url('searchbar/assets/js/jquery-1.10.2.min.js')}}"></script> 
        <script src="{{url('searchbar/bootstrap/js/bootstrap.min.js')}}"></script>
        <script src="{{url('searchbar/assets/js/bootstrap-select.min.js')}}"></script>
        <script src="{{url('searchbar/assets/js/bootstrap-hover-dropdown.js')}}"></script>
        <script src="{{url('searchbar/assets/js/owl.carousel.min.js')}}"></script>
        <script src="{{url('searchbar/assets/js/wow.js')}}"></script>
        <script src="{{url('searchbar/assets/js/icheck.min.js')}}"></script>
        <script src="{{url('searchbar/assets/js/price-range.js')}}"></script>
        <script src="{{url('searchbar/assets/js/main.js')}}"></script>
