                ...
                <div class="col-md-4 col-sm-6">
                    <section class="widget about-widget clearfix">
                        ...
                        <a class="footer-logo" href="#">
                            <img src="{{ URL::asset('assets/images/footer-logo.png') }}" alt="Footer Logo">
                        </a>
...
<script src="{{ URL::asset('plugins/slick-nav/jquery.slicknav.min.js') }}"></script>
<script src="{{ URL::asset('plugins/slick/slick.min.js') }}"></script>
<script src="{{ URL::asset('plugins/jquery-ui/jquery-ui.min.js') }}"></script>
<script src="{{ URL::asset('plugins/tweetie/tweetie.js') }}"></script>
<script src="{{ URL::asset('plugins/forms/jquery.form.min.js') }}"></script>
<script src="{{ URL::asset('plugins/forms/jquery.validate.min.js') }}"></script>
<script src="{{ URL::asset('plugins/modernizr/modernizr.custom.js') }}"></script>
<script src="{{ URL::asset('plugins/wow/wow.min.js') }}"></script>
<script src="{{ URL::asset('plugins/zoom/zoom.js') }}"></script>
<script src="{{ URL::asset('plugins/mixitup/mixitup.min.js') }}"></script>
<script src="../../../maps.googleapis.com/maps/api/js7809?key=AIzaSyD2MtZynhsvwI2B40juK6SifR_OSyj4aBA&amp;libraries=places"></script>
<script src="{{ URL::asset('plugins/whats-nearby/source/WhatsNearby.js') }}"></script>
<script src="{{ URL::asset('assets/js/theme.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/js/head.js') }}"></script>
